...
const businessTypes = [
  { value: 'hospitality', label: 'Hotel / Resort', icon: Hotel,    description: 'Rooms, villas, dorms and stay bookings' },
  { value: 'events',      label: 'Events',         icon: Calendar, description: 'Events, venues, workshops and halls' },
  { value: 'products',    label: 'Products',       icon: Store,    description: 'Retail, e-commerce and product sales' },
]
